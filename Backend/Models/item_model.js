...
const itemSchema = new mongoose.Schema({
  ...
  size: { type: String, required: [true,"Please Select Shoe Size"], enum: ['40', '41', '42', '43', '44'], default: '40' },
  brand: { type: String, required: [true,"Please Select Item Brand"], enum: ['Nike', 'Addidas', 'Puma', 'New Balance', 'Tommy'] },
